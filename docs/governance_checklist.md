...
**Roboflow Version:** [PPE-Detection-Group5](https://app.roboflow.com/mark-shane-haines-zigurat/ppe-detection-group5) (YOLOv8 format, 640×640)

**Date Collected:** Original dataset published 2023. Pseudo-labels generated March 2026.
...
**Class Confusion Risk (Critical):** A beanie or baseball cap is classified as "Helmet" — the system reports compliance when the worker is actually unprotected. This is worse than a false negative because it actively provides false reassurance. See `docs/error_analysis.md` CC-1.
...
- **Extreme backlighting:** Workers silhouetted against bright sky may not be detected (see `docs/error_analysis.md` FN-2).
- **Non-standard PPE:** Blue or red vests, full-sleeve vests, and non-standard goggle types may be missed (see `docs/error_analysis.md` FN-3).
