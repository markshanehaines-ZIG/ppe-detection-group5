...
3. Open the repository in VS Code (with Python extensions)
4. Install dependencies using uv: `uv sync`
5. Run the Jupyter Notebook: `uv run jupyter notebook notebooks/MAICEN_1125_M4_U4_Group_5_Assignment.ipynb`
